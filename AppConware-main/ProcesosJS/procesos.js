...
function borrarTodo(){
  ...
  document.getElementById("nota").value = "Se comunica el cliente informando que no le funciona el servicio de internet,indica que realizó los descartes de primer nivel,no ha realizado cambios en la red interna,no ha presetnado fallas en la red electrica, notifica que el led LOS en el equipo esta encendido."+"\n"+"\n"+"Se comunica el cliente idicando que esta presentando o experimentado intermitencia en el servicio de internet,indica que ha realizado los descartes de primer nivel,no ha realizado cambios en la red o modificaciones.";
